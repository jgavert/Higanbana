...
{
private:
  static void runTestsForDevice(GpuDevice& dev, GraphicsQueue& queue, Window& window, SwapChain& sc, ViewPort& port, GraphicsCmdBuffer& gfx)
  {
...
public:
  static void run(GpuDevice& dev, GraphicsQueue& queue, Window& window, SwapChain& sc, ViewPort& port, GraphicsCmdBuffer& gfx)
  {
