...
// just with info byte
namespace RobinHoodInfobytePairNoOverflow {
  ...
  >
    ...
    public:
      ...
      void clear() {
        ...
        std::memset(_info, 0, sizeof(typename Traits::InfoType) * _max_elements);
        _num_elements = 0;
      }
      ...
      inline ~Map() {
        ...
        _alloc_keyvals.deallocate(_keyvals, _max_elements);
      ...
      inline const_iterator find(const key_type& key) const {
        ...
        size_t idx = (original_idx - info + Traits::IS_BUCKET_TAKEN_MASK) & _mask;
      ...
      inline float load_factor() const {
        return _num_elements / static_cast<float>(_max_elements);
      }
    ...
    private:
      ...
      inline void init_data(size_t max_elements) {
        ...
        _keyvals = _alloc_keyvals.allocate(_max_elements);
        _info = _alloc_info.allocate(_max_elements, _keyvals);
      ...
      inline void increase_size() {
        ...
        _alloc_keyvals.deallocate(old_keyvals, old_max_elements);
