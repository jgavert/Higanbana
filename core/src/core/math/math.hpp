...
using float2 = faze::math::Vector<2, float>;
using float3 = faze::math::Vector<3, float>;
using float4 = faze::math::Vector<4, float>;

using double2 = faze::math::Vector<2, double>;
using double3 = faze::math::Vector<3, double>;
using double4 = faze::math::Vector<4, double>;

using int2 = faze::math::Vector<2, int>;
using int3 = faze::math::Vector<3, int>;
using int4 = faze::math::Vector<4, int>;

using uint = unsigned;
using uint2 = faze::math::Vector<2, unsigned>;
using uint3 = faze::math::Vector<3, unsigned>;
using uint4 = faze::math::Vector<4, unsigned>;

using float3x3 = faze::math::Matrix<3, 3, float>;
using float4x4 = faze::math::Matrix<4, 4, float>;

using quaternion = faze::math::Quaternion;
