// INTERFACE_HASH:18252467159132830769:13170107249973831902
...
struct Constants
{float4 originPoint; float frameTimeDiff; uint maxParticles; };
...
// Read Only resources
VK_BINDING(0, 0) StructuredBuffer<Particle> previous : register( t0, space0 );

// Read Write resources
VK_BINDING(1, 0) RWStructuredBuffer<Particle> current : register( u0, space0 );
