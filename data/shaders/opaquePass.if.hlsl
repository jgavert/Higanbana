// INTERFACE_HASH:6712057018530971370:11488914943106011754
...
struct Constants
{float resx; float resy; float time; int stretchBoxes; float4x4 worldMat; float4x4 viewMat; float4 color; };
