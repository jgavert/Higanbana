...
namespace faze
{
  namespace renderer
  {
    ...
    void Blitter::blit(GpuDevice& device, CommandGraphNode& rp, TextureRTV& target, TextureSRV& source, float2 topleft, float2 size)
    {
    ...
    void Blitter::blit(GpuDevice& device, CommandGraphNode& rp, TextureRTV& target, TextureSRV& source, int2 itopleft, int2 isize)
    {
    ...
    void Blitter::blitImage(GpuDevice& device, CommandGraphNode& rp, TextureRTV& target, TextureSRV& source, FitMode mode)
    {
