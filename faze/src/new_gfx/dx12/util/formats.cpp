...
namespace faze
{
  namespace backend
  {
    static constexpr FormatDX12Conversion DXFormatTransformTable[] =
    {
      ...
      { DXGI_FORMAT_R8G8B8A8_TYPELESS,      DXGI_FORMAT_R8G8B8A8_UINT,       DXGI_FORMAT_R8G8B8A8_UINT,        FormatType::Uint8x4 },
      ...
      { DXGI_FORMAT_R8G8B8A8_TYPELESS,      DXGI_FORMAT_R8G8B8A8_SINT,       DXGI_FORMAT_R8G8B8A8_SINT,        FormatType::Int8x4 },
